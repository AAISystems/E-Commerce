...
@section('title', 'Descuentos - Categoría')

@section('content')
    <div class="container mt-3">
        <h1 class="text-center mb-4 fw-light">Creando un descuento de Categoría</h1>
    ...
    @endif
        ...
        <form action="{{route('discount.saveCategory')}}" method="post" class="shadow-sm border p-3">
            @csrf
            ...
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-lg" name="categoryToAdd" id="categoryToAdd" required>
